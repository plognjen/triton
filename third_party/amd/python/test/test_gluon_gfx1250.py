...
@pytest.mark.parametrize("BLOCK_M,BLOCK_N", [(256, 128)])
@pytest.mark.parametrize("NUM_BUFFERS", [1])
@pytest.mark.parametrize("NUM_WARPS", [4])
@pytest.mark.parametrize("ASYNC_LOAD_TYPE", ["DEVICE_TDM", "DEVICE_TDM_PARTITIONED"])
