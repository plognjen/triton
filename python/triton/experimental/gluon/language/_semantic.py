...
from ._layouts import AutoLayout, DistributedLayout, GenericLinearLayout, DistributedLinearLayout, SliceLayout, SharedLayout, CoalescedLayout, SharedLinearLayout
...
class GluonSemantic(TritonSemantic[TensorTy]):
    ...
    def to_linear_layout(self, layout, shape):
        ...
        if isinstance(layout, (AutoLayout, GenericLinearLayout, SharedLinearLayout)):
